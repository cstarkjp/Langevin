...
The `C++` code base is organized as follows.
...
Next, the code is split into a hierarchy of three groups, with files in each group denoted by one of the following prefixes: 
