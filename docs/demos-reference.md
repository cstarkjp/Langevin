...
### [dp_periodic.py](https://github.com/cstarkjp/Langevin/tree/main/demos/dp_periodic.py)

Example 2D grid with periodic edge (toroidal) topology. Run with:

        python demos/dp_periodic.py

<!-- ### [dp_mixed.py][dp_mixed.py] -->
### [dp_mixed.py](https://github.com/cstarkjp/Langevin/tree/main/demos/dp_mixed.py)
